...
namespace GitHubMonitorApp
{
    public class GitHubMonitor
    {
        ...
        //This azure function will trigger whenever something is pushed to github repo.

        [Function("GitHubMonitor")]//name of Azure function
        //Azure uses decorator in order to identify what type of function it is
        //HttpTrigger: It is a Http request
        //AuthorizationLevel is function
        //GET POST: These are the ways we can access the url
        public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post")] HttpRequest req)
        {
            _logger.LogInformation("Github Monitor processed an action.");

            // string name = req.Query["name"];//query string parameter

            string requestBody = await new StreamReader(req.Body).ReadToEndAsync();
            var data = JsonConvert.DeserializeObject<Rootobject>(requestBody);
            //name = name ?? data?.name;
            _logger.LogInformation(data?.sender.avatar_url);
